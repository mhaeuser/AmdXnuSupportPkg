...
{
  return mMpService->GetNumberOfProcessors (
                       mMpService,
                       NumberOfProcessors,
...
{
  return mMpService->GetProcessorInfo (
                       mMpService,
                       ProcessorNumber,
                       ProcessorInfoBuffer
                       );
...
{
  return mMpService->StartupAllAPs (
                       mMpService,
                       Procedure,
                       SingleThread,
                       WaitEvent,
...
{
  return mMpService->StartupThisAP (
                       mMpService,
                       Procedure,
                       ProcessorNumber,
                       WaitEvent,
...
{
  return mMpService->SwitchBSP (mMpService, ProcessorNumber, EnableOldBSP);
}
...
{
  return mMpService->EnableDisableAP (
                       mMpService,
                       ProcessorNumber,
                       EnableAP,
                       HealthFlag
...
{
  return mMpService->WhoAmI (mMpService, ProcessorNumber);
}
